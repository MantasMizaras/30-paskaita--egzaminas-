...
function filterDogOwners(array) {
  return array.filter((userObj) => userObj.hasDog === true);
}
...
function filterAdults(array) {
  return array.filter((userObj) => userObj.age >= 18);
}
const adultsOnly = filterAdults(users);
// console.log("adultsOnly ===", adultsOnly);
